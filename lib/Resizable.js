...
type State = {
  ...
  prevClient: [number | null, number | null]
};
...
export default class Resizable extends React.Component<Props, State> {
  ...
  resizeHandler(handlerName: string, axis: ResizeHandle): Function {
    return (e: MouseEvent, {node, deltaX, deltaY}: DragCallbackData) => {
      ...
      if (hasCb) {
        ...
        this.setState(newState, () => this.props[handlerName](e, {node, size: {width, height}, inverted, handle: axis}));
      } else {
